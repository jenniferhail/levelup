...
theme.Header = (function() {
  ...
  function init() {
    ...
    cache.$parents.hover(function(evt) {
      var $el = $(this);
...
theme.BlogSlide = (function() {
  ...
  function BlogSlide(container) {
    var $container = (this.$container = $(container));
    var sectionId = $container.attr('data-section-id');
    var wrapper = (this.wrapper = '.blogslide-wrapper');
    var slider = (this.slider = '#BlogSlide-' + sectionId);
    var $slider = $(slider, wrapper);
 ...
 BlogSlide.prototype = _.assignIn({}, BlogSlide.prototype, {
    onUnload: function() {
      enquire.unregister(config.mediaQuerySmall);
      enquire.unregister(config.mediaQueryMediumUp);
    ...
    onBlockSelect: function(evt) {
      // Ignore the cloned version
      var $slide = $(
        '.blogslide-slide:not(.slick-cloned)'
      );
      var slideIndex = $slide.data('slick-index');
...
$(document).ready(function() {
  ...
  sections.register('blog-slide', theme.BlogSlide);
});
